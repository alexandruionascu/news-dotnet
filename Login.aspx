            ...
            <div class="box col s4 offset-s4 z-depth-4 card-panel">
                ...
                <div class="row">
                  <div class="input-field col s12 center">
                    <img src="IMG/news.png" width="100" class="circle responsive-img valign profile-image-login">
                    <p class="center login-form-text">Log in</p>
                  </div>
                </div>
                <form class="col s12">
                  <div class="row">
                  ...
                  <div id="Eroare" class="center-align" onserverclick="Login_Click" runat="server"></div>
                  <div class="row">
                    <div class="input-field col s12">
